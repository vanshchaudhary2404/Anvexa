  ...
  useEffect(() => {
    ...
    const fetchMyOrders = async () => {
      try {
        ...
        toast.error('Unable to load your order history. Please try again.');
        setOrders([]);
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div style={containerStyle}>
      ...
      {loading ? (
        ...
        <div style={{ background: '#09090b', padding: '30px', borderRadius: '8px', textAlign: 'center', border: '1px solid #ef4444' }}>
